/**
 * Source: https://github.com/JDub20/CodeBlocks/blob/master/appinventor/blockslib/src/openblocks/codeblocks/rendering/BlockShapeUtil.java
 */
public static void printPath(GeneralPath gp)
{
        ...
        while(!i.isDone()) {
            ...
            if(type == PathIterator.SEG_MOVETO)
                ...
                System.out.println("q: (" + segment[0] + ", " + segment[1] + "), 
                (" + segment[2] + ", " + segment[3] + ")");
            else if(type == PathIterator.SEG_CUBICTO)
                System.out.println("c: (" + segment[0] + ", " + segment[1] + "), 
